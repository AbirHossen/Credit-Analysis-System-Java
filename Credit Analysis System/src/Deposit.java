...
public class Deposit extends JFrame {
	...
	public Deposit() {
		...
		setTitle("Deposit");
		setResizable(false);
		setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\Deposit.jpg")));
				...
				public void actionPerformed(ActionEvent e) 
				{
					if(Double.parseDouble(depositAmountTxt.getText())>0)
					{
				    	try
				    	{
					    	...
					    	//insertion operation in deposit table
					    	...
					    	//update operation in customer_info table
							...
							//insertion operation in transaction table
