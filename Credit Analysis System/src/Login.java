...
public class Login extends JFrame { 
	...
	{	
		...
		JLabel label = new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\Login.jpg"));
		...
		txtLoginInfo.setFont(new Font("Agency FB", Font.BOLD, 25));
		txtLoginInfo.setBounds(200, 0, 500, 62);
