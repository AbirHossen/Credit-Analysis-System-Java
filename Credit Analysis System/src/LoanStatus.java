...
public class LoanStatus extends JFrame{
	...
	public LoanStatus() {
		...
		setResizable(false);
		setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\LoanStatus.jpg")));
			...
			btDecline.addActionListener(new ActionListener() 
			 {
					public void actionPerformed(ActionEvent e) 
					{
						 try
							{	 
							 	String query ="delete from loan where Account_No=? and loan_status=?";
							 	PreparedStatement pst = (PreparedStatement) connection.prepareStatement(query);
