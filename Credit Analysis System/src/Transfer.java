...
public class Transfer extends JFrame{
	...
	public Transfer() {
		...
		setResizable(false);
		setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\Transfer.jpg")));
				    	...
				    	{	
							...
							rs1 = ps.executeQuery();
							    ...
							    { 
							    	...
							    	String query5 ="insert into transaction (Account_No,TransformFrom,TransferTo,Amount,CDate) values (?,?,?,?,?) ";
