...
public class ShowFd extends JFrame{
	...
	public ShowFd() {
		...
		setResizable(false);
		setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\ShowFd.jpg")));
		...
		labelFixedDeposits.setFont(new Font("Agency FB", Font.BOLD, 45));
		labelFixedDeposits.setBounds(540, -13, 527, 108);
		getContentPane().add(labelFixedDeposits);
