...
public class TransactionHistory extends JFrame{
	...
	JLabel labelTransactionHistory = new JLabel("Transaction History");
	Connection connection=null;
	JButton btShowDetails = new JButton("Show All Transactions");
	...
	public TransactionHistory() {
		...
		setResizable(false);
		setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\TransactionHistory.jpg")));
		...
		labelTransactionHistory.setForeground(Color.BLACK);
		labelTransactionHistory.setFont(new Font("Agency FB", Font.BOLD, 45));
		labelTransactionHistory.setBounds(451, -13, 527, 108);
		getContentPane().add(labelTransactionHistory);
