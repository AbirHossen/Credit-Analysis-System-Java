...
public class ForgetPassword extends JFrame 
{
	...
	public ForgetPassword()
	{
		...
		JLabel label = new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\ForgetPassword.jpg"));
			...
			public void actionPerformed(ActionEvent e1) 
			{
				...
				{	
					...
					try { 
						...
						String query2 = "update user_info set Password=? where Username='"+userName+"'";
