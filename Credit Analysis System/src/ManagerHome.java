	...
	public ManagerHome()
	 	{
			 ...
			 setFocusable(true);
			 setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\ManagerHome.jpg")));
			...
			userAll.setFont(new Font("Agency FB", Font.PLAIN, 24));
				user.add(userAll);
					...
					JMenuItem loanVerific = new JMenuItem("Loan Verification");
					loanVerific.setFont(new Font("Agency FB",Font.PLAIN,24));
					view.add(loanVerific);
					
					JMenuItem curRatio = new JMenuItem("Current Ratio");
					curRatio.setFont(new Font("Agency FB",Font.PLAIN,24));
					view.add(curRatio);
				...
				//actions are handled here on mouse click on the menu item
					...
					loanVerific.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							LoanVerific l = new LoanVerific();
							l.show();
						}
					});
					...
					curRatio.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							curRatio l = new curRatio();
							l.show();
