...
public class RemoveUser extends JFrame
{
	...
	JLabel labelUpdateUser = new JLabel("Remove User");
	...
	public RemoveUser()
	{
		...
		setContentPane(new JLabel(new ImageIcon("F:\\java\\Projects\\Credit Analysis System\\Images\\RemoveUser.jpg")));
		...
		labelUname.setBounds(150,90,100,80);
		...
		labelDateBirth.setBounds(150,330,110,80);
		...
		btRemove.setFont(new Font("Agency FB", Font.BOLD, 24));
		...
		DateComboBox.setBounds(300, 360, 46, 25);
		...
		MonthComboBox.setBounds(370, 360, 83, 25);
		...
		YearComboBox.setBounds(470, 360, 70, 25);
		...
		showDate.setFont(new Font("Agency FB", Font.BOLD, 24));
